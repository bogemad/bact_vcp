...
import os, shutil, subprocess, gzip, sys, collections, re
...
#read-groups!
def run_smalt(reads,base_path,temp_dir,sample_name):
	unmerge(reads, sample_name, gz=True)
	reads1 = "%s.1.fastq.gz" % sample_name
	reads2 = "%s.2.fastq.gz" % sample_name
